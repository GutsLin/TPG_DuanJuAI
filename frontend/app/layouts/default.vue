      ...
      <div class="header-left">
        <button class="brand" @click="navigateTo('/')">
          <div class="brand-mark">
            <img v-if="showBrandImage" :src="brandLogo" alt="调皮狗短剧" class="brand-logo" @error="showBrandImage = false" />
            <span v-else class="brand-fallback">调</span>
          </div>
          <div class="brand-text">
            <span class="brand-name">调皮狗短剧</span>
            <span class="brand-sub">TPG Shorts</span>
          </div>
        </button>
      </div>
